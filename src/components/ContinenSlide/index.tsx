  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide className={styles.swiperSlide}><Link href='/continent'><Flex flexDirection='column' w='full' h='full' backgroundImage='./images/asia.jpg' backgroundPosition='top' alignItems='center' justifyContent='center' cursor='pointer'><Text color='white' fontSize='4xl' fontWeight='bold'>Asia</Text><Text color='white' fontSize='xl' fontWeight='bold'>The oldest continent</Text></Flex></Link></SwiperSlide>
